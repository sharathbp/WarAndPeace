...
void intro(){
	...
	glColor3f(0.0, 0.0, 0.0);
	draw_text2(1.5, -0.9, -1, "Under the guidance of");
	draw_text2(1.5, -1.05, -1, "Prof K.J.Banushree");
	draw_text2(1.5, -1.2, -1, "Prof N Thanuja");
	draw_text2(1.5, -1.35, -1, "Prof Shruthi B R");
